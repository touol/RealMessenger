...
class RealMessengerOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('realmessenger_item_err_ns');
        }
...
return 'RealMessengerOfficeItemUpdateProcessor';
