...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'RealMessenger',
                'description' => 'Default source for files of RealMessenger',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/realmessenger/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'realmessenger_source_default'))) {
